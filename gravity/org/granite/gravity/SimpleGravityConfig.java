 ...
 * @author Franck WOLFF
 */
public class SimpleGravityConfig implements GravityConfig, GraniteConfigReloadListener {
	...
	public SimpleGravityConfig(GraniteConfig graniteConfig, ChannelFactory channelFactory) {
