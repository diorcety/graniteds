 ...
 * @author Franck WOLFF
 */
public class SimpleDestination implements Destination,Serializable {
    ...
    public SimpleDestination(String id, List<String> channelRefs, XMap properties, List<String> roles, Adapter adapter, Class<?> scannedClass) {
        this.id = id;
    ...
    public static Destination forElement(XMap element, Adapter defaultAdapter, Map<String, Adapter> adaptersMap) {
        ...
        return new SimpleDestination(id, channelRefs, properties, rolesList, adapterRef, null);
    }
}
