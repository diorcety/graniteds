 ...
 * @author Franck WOLFF
 */
public class SimpleGraniteConfig implements GraniteConfig,ScannedItemHandler {

    ///////////////////////////////////////////////////////////////////////////
    // Static fields.

    private static final Logger log = Logger.getLogger(SimpleGraniteConfig.class);
    ...
    public SimpleGraniteConfig(String stdConfig, InputStream customConfigIs, Configuration configuration, String MBeanContextName) throws IOException, SAXException {
        try {
